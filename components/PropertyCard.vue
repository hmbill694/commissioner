                ...
                <div class="card-body p-4">
                    <div class="flex justify-between items-center">
                        <h2 class="text-xl font-bold mb-4">
                            {{ property.name ?? "Your future home" }}
                        </h2>
                        <SignedIn>
                    ...
                    <div class="flex justify-center bg-gray-500 rounded-lg">
                        <svg fill="#fffffff" height="200px" width="200px" version="1.1" id="Capa_1"
                    ...
                    <p class="text-sm mt-2" v-if="property.description">
                        {{ truncateDescription(property.description) }}
                    </p>
                    <div class="card-actions justify-end mt-4">
                        <NuxtLink :to="`property/${property.id}`" class="btn btn-primary">View Property</NuxtLink>
                        <SignedIn>

...
<template>
  <div class="card shadow-lg bg-base-200">
    <div class="card-body p-4">
      ...
      <div class="flex justify-center bg-gray-500 rounded-lg">
        <svg fill="#fffffff" height="200px" width="200px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 486.196 486.196" xml:space="preserve">
      ...
      <p class="text-lg">
        Asking Price: {{ props.property.askingPrice }}
      </p>
      <p class="text-lg">
        Commission: {{ props.property.commissionRate }}
      </p>
      <p class="text-sm mt-2" v-if="props.property.description">
        {{ truncateDescription(props.property.description) }}
      </p>
      <div class="card-actions justify-end mt-4">
        <NuxtLink :to="`/property/${props.property.id}`" class="btn btn-primary">View Property</NuxtLink>
        <form action="dashboard?markSold" method="post">
